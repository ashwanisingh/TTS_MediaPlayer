...
public class CrystalSeekbar extends View {
    ...
    public CrystalSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try{
            ...
            thumbWidth = array.getDimension(R.styleable.CrystalRangeSeekbar_thumb_width, 0f);
            thumbHeight = array.getDimension(R.styleable.CrystalRangeSeekbar_thumb_width, 0f);
            barHeight = array.getDimension(R.styleable.CrystalRangeSeekbar_bar_height, 0f);
        }
        finally {
            array.recycle();
        }
